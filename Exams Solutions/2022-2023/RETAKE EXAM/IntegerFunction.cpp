//Edin klas funkcija int->int koeto da e virtualen klas sa izhisleneto na funkcijata
//Edin klas naslednik koeto da e konkretna funkcija kojato ima kato parameter ili funkcija ili obekt
//Drug naslednik maximum funkcija kojato pri konstruktora da ima integers functioni obektii da vershta
//nai goljamoto
//Analogichno I za min
//Imame dve failover exclude kedeto chisla sa otdeleni s interval primerno 4 5 6
//I include.txt kedeto sa primerno
//4
//5
//6
//Dajte programa koeto cheta ot failovete I f1(x) da vershta chisloto ako toe ne seshtestvuva f(1) = 1
//I 0 ako sshtestvuva
//F2(x) da vershta 0 ako toe seshtestvuva I samoto chislo ako ne no ne sem sigg//!!
//F3(x) da vershta nai goljamoto ot te primerno
//Ako f1(5) = 5 I f2(5) = 5 to f3(5) = 5
//Ako f1(0) = 0 I f2(0) = 1 to fr(0) = 1
#include <iostream>
#include <fstream>
#include <stdexcept>
#include <climits>
